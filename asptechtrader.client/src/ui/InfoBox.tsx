...
const InfoBox = ({ des, title, optionDes }: Props) => {
  return (
    <div className="bg-stone-200 hover:bg-yellow-300 h-14 p-1 ps-2 dark:bg-gray-600 dark:hover:bg-[#d1bb1597] hover:dark:text-white transition-all cursor-pointer">
